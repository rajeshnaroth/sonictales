...
export const works: Work[] = [
  // Sorted by publishing date (oldest to newest)
  {
    ...
    description: 'Love calls. Will you answer? Former lovers Rameez and Soni meet after several years. As they struggle to reconnect, old flames are rekindled. Official Selections: Melbourne Independent Film Festival, Portobello Film Festival, Walnutcreek Short Film Festival (2013).',
    credits: {
  ...
  },
  {
    ...
    description: 'A young boy longs for his father\'s love but the father is drowned in the worries of life. A touching story about family connections and the importance of being present. Shot with BMCC and edited with Adobe CC, Resolve, and Pro Tools.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
  ...
  },
  {
    ...
    description: 'Jacob needs a mom. There is one available on Craig\'s list. It wasn\'t as easy as he thought. A heartwarming comedy-drama about family, connection, and the unexpected places we find love.',
    credits: {
      director: 'Rajesh Naroth',
  ...
  },
  {
    ...
    description: 'Sally is having a bad day. She had no idea how worse it was going to get. A powerful PSA about heatstroke prevention and child safety, featuring compelling performances and important social messaging.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
      cinematographer: 'Unni Raveendranathen',
  ...
  },
  {
    ...
    description: 'A powerful one-minute short film that follows Vanessa Becker as she makes an important status update. Winner of 10 Official Selections and 2 Awards, this film explores themes of domestic abuse and personal transformation through social media.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
      cinematographer: 'Unni Raveendranathen',
  ...
  },
  {
    ...
    description: 'Some decisions are tough. A challenging day in the life of Ms. Davis. This 6-minute drama has been a film festival favorite in the 2015 circuit, racking up over 56 official selections and 7 awards. A deeply moving story about difficult choices and saying goodbye.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
      cinematographer: 'Darren Rae',
  ...
  },
  {
    ...
    description: 'Sheela\'s son is missing. She copes by helping to find other missing children. Filmed in San Jose and Half Moon Bay locations in Northern California, this emotionally powerful short film explores themes of loss, hope, and healing through community service.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
      cinematographer: 'Rajesh Naroth',
  ...
  },
  {
    ...
    description: 'Your baby is safe. Are you? A spine-chilling horror short that explores modern parenting anxieties through the lens of technology. Based on an idea from Reddit, this Halloween 2016 release masterfully builds tension and delivers genuine scares.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Austin Smagalski',
      cinematographer: 'Darren Rae',
  ...
  },
  {
    ...
    description: 'Sometimes, love means wishing for the end. Daya sacrifices her career to care for her ailing mother, uncovering long-buried truths and unspoken love as she navigates the fragile line between life, loss, and reconciliation. Features music by Rabindranath Tagore.',
    credits: {
      director: 'Rajesh Naroth',
      editor: 'Rajesh Naroth',
