...
export const ControlPanel = ({
  ...
  <div className="flex flex-col gap-3 p-3 bg-gray-800 rounded-lg border border-gray-700">
    ...
    {/* Bottom row: Feedback and transport controls */}
    <div className="flex flex-wrap items-center gap-3">
      <div className="flex items-center gap-2">
        <label className="text-gray-400 text-sm font-medium">Feedback</label>
        <input
          type="range"
          min="0"
          max="95"
          ...
          className="w-24 h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-amber-500"
        />
        <span className="w-10 text-right text-gray-300 text-sm font-mono">{feedback}%</span>
      </div>
      ...
      <button
        ...
        className={`px-4 py-1.5 rounded font-bold text-sm transition-colors ${isPreviewing ? "bg-purple-600 hover:bg-purple-500 text-white" : "bg-purple-700 hover:bg-purple-600 text-white"}`}
        title="Preview delay pattern with feedback"
      >
