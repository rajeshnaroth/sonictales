      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-2xl text-white/70 mb-4">Independent Film Production</h2>
          </div>

          {/* Founder Bio */}
          <div className="space-y-6 text-white/80 leading-relaxed mb-16 max-w-3xl">
            <p>
              Rajesh Naroth is an indie filmmaker and sound designer based in San Jose, CA, and the founder of the production company SonicTales. He began his career in the industry composing music
              and producing music videos, and quickly expanded into writing and directing short films.
            </p>
            <p>
              Rajesh has collaborated closely with composer Enis Rothoff and contributed his expertise in sound design to Hollywood films, including Trigger Warning. His films have been screened at
              festivals worldwide. His one-minute short Status Change has been featured in over 23 festivals and won three awards, while his short film Max has achieved international acclaim,
              screening at more than 60 festivals and earning eight Best Film awards.
            </p>
            <p>Through SonicTales, Rajesh continues to create compelling narrative short films and immersive audio experiences that explore the complexities of the human experience.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 w-full max-w-4xl mb-16">
            <div>
              ...
              <div className="space-y-4 text-white/70 text-left">
                <div>
                  ...
                  <p className="text-sm">23 Festivals • 3 Awards</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm">60+ Festivals • 8 Best Film Awards</p>
                </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {["Short Films", "Character Drama", "Music Videos", "Film Composition", "Festival Submissions", "Independent Cinema", "Narrative Storytelling"].map((specialty) => (
                  <span key={specialty} className="px-3 py-1 bg-white/10 rounded-full text-sm text-white/80">
                    {specialty}
                  </span>
                ))}
              </div>
